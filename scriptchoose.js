...
for (let i = 0; i < 6;++i){
    ...
    if (!els[i].checked){
        ...
        els[i].parentElement.parentElement.childNodes[1].childNodes[1].setAttribute("disabled", "disabled");
    } else {
        ...
        els[i].parentElement.parentElement.childNodes[1].childNodes[1].removeAttribute("disabled");
    }
    els[i].onclick = function() {
        if (!this.checked){
            ...
            this.parentElement.parentElement.childNodes[1].childNodes[1].setAttribute("disabled", "disabled");
        } else {
            ...
            this.parentElement.parentElement.childNodes[1].childNodes[1].removeAttribute("disabled");
        }
    };
}